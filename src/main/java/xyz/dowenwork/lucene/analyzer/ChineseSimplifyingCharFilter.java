 ...
 * @since 5.5.0.0
 */
public class ChineseSimplifyingCharFilter extends BaseCharFilter {
    private Reader transformedInput;

    public ChineseSimplifyingCharFilter(Reader in) {
        super(in);
    }
    ...
    private void fill() throws IOException {
        ...
        transformedInput = new StringReader(
                ChineseSimplifyingTransformer.traditionalToSimplified(buffered.toString()));
    }
